  ...
  return (
    <main className="local-seo-page">
      ...
      <section className="local-seo-hero">
        ...
        <div className="local-seo-trust"><span><ShieldCheck size={17} /> Registerkontrollerade företag</span><span><Clock3 size={17} /> Snabb återkoppling</span><span><MapPin size={17} /> {area.name} och närområde</span></div>
